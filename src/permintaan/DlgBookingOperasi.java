...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnDigitalPerawatan = new widget.Button();
        ...
        BtnDigitalPerawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnDigitalPerawatan.setText("Berkas Digital Perawatan");
        BtnDigitalPerawatan.setToolTipText("");
        BtnDigitalPerawatan.setFocusPainted(false);
        BtnDigitalPerawatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDigitalPerawatan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnDigitalPerawatan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDigitalPerawatan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnDigitalPerawatan.setName("BtnDigitalPerawatan"); // NOI18N
        BtnDigitalPerawatan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnDigitalPerawatan.setRoundRect(false);
        BtnDigitalPerawatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDigitalPerawatanActionPerformed(evt);
            }
        });
        FormMenu.add(BtnDigitalPerawatan);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnDigitalPerawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDigitalPerawatanActionPerformed
        // TODO add your handling code here:
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
            ...
            if(tbObat.getSelectedRow()!= -1){
                ...
                try {
                    if(akses.gethapus_berkas_digital_perawatan()==true){
                        berkas.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/"+"berkasrawat/login2.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+TNoRw.getText().toString());
                    }else{
                        berkas.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/"+"berkasrawat/login2nonhapus.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+TNoRw.getText().toString());
                    }   
                } catch (Exception ex) {
    ...
    }//GEN-LAST:event_BtnDigitalPerawatanActionPerformed
    ...
    */
    ...
    private widget.Button BtnDigitalPerawatan;

                        ...
                        try {
                            ...
                            try {
                                ...
                                json = "{\n"
                                        ...
                                        + "            }\n"
                                        + "        ],\n"
                                        + "        \"text\": \"Kontrol kembali ke Rumah Sakit Bhayangkara Palu pada tanggal " + tbKamar.getValueAt(i, 15).toString() + " \"\n"
                                        + "    },\n"
                                        + "    \"subject\": {\n"
                                        ...
                                        + "        }\n"
                                        + "    ],\n"
                                        + "    \"patientInstruction\": \"Kontrol kembali ke Rumah Sakit Bhayangkara Palu pada " + tbKamar.getValueAt(i, 15).toString() + ". \"\n"
                                        + "}";
                        ...
                        try {
                            ...
                            try {
                                ...
                                json = "{\n"
                                        ...
                                        + "            }\n"
                                        + "        ],\n"
                                        + "        \"text\": \"Kontrol kembali ke Rumah Sakit Bhayangkara Palu pada tanggal " + tbKamar1.getValueAt(j, 15).toString() + " \"\n"
                                        + "    },\n"
                                        + "    \"subject\": {\n"
                                        ...
                                        + "        }\n"
                                        + "    ],\n"
                                        + "    \"patientInstruction\": \"Kontrol kembali ke Rumah Sakit Bhayangkara Palu pada " + tbKamar1.getValueAt(i, 15).toString() + ".\"\n"
                                        + "}";
                                System.out.println("URL : " + link + "/ServiceRequest");
                                System.out.println("Request JSON : " + json);
                                requestEntity = new HttpEntity(json, headers);
                        ...
                        try {
                            ...
                            try {
                                ...
                                json = "{\n"
                                        ...
                                        + "        }\n"
                                        + "    ],\n"
                                        + "    \"patientInstruction\": \"Rencana Tindak Lanjut Rawat Inap di RS Bhayangkara Palu pada " + tbKamar2.getValueAt(i, 15).toString()
                                        + ".\"\n"
                                        + "}";
                                System.out.println("URL : " + link + "/ServiceRequest");
                                System.out.println("Request JSON : " + json);
